...
void setup() {
        ...
        Serial.println(F("This code is for writing questions on the cards "));
}
...
// Read Info
  Serial.print(F("The current question is:  "));
  ...
  Serial.print(":Did you have a good sleep last night?");
